...
哈希表也称散列表，用于将要插入的数值尽可能分散的放入一组数组，其中根据要放入的参数可以计算出一个其对应的哈希值，根据这个哈希值就可以尽快找到要插入的位置也可以尽快找到待查找数值的位置。哈希表通常可以由一个数组+多个链表组合形成。

**图解**

![1572613066923](C:\Users\DELL\AppData\Roaming\Typora\typora-user-images\1572613066923.png)

![1572613083501](C:\Users\DELL\AppData\Roaming\Typora\typora-user-images\1572613083501.png)
